...
export function ValidatedInput({
  ...
  const getBorderColor = () => {
    if (!showValidation || !isTouched) return 'border-gray-300 focus:border-yellow-500';
  ...
  const getRingColor = () => {
    if (!showValidation || !isTouched) return 'focus:ring-yellow-500';
    return validation.isValid 
    ...
    <div className={className}>
      ...
      <div className="relative">
        <input
          ...
          className={`
            w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-opacity-50 transition-colors duration-200
