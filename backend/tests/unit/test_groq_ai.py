...
async def test_groq_service():
    ...
    try:
        analysis = await groq_service.analyze_resume("Sample resume text", sample_resume_data)
...
async def test_ai_analyzer():
    ...
    try:
        ...
        analysis = await analyzer.analyze_resume_comprehensive(tmp_file_path, job_context)
