        ...
        for test_case in test_cases:
            ...
            for field in required_fields:
                if field not in formatted_job:
                    raise Exception(
                        f"Missing required field {field} for {test_case['name']}"
                    )
